...
public enum WSInputs implements Inputs
{
   ...
   MAN_LEFT_JOYSTICK_Y("Manip Intake in_out", WSInputType.JS_JOYSTICK,
         ...
         getLogging()),
   MAN_DPAD_X("Manip DPAD X", WSInputType.JS_JOYSTICK,
         new WsJSJoystickInputConfig(1, JoystickConstants.DPAD_X),
         getLogging()),
   MAN_DPAD_Y("Manip DPAD Y", WSInputType.JS_JOYSTICK,
         new WsJSJoystickInputConfig(1, JoystickConstants.DPAD_Y),
         getLogging()),
