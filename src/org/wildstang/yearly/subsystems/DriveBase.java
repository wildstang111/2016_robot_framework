...
public class DriveBase implements Subsystem {
	...
	public void updateDriveMotors() {
		...
		((AnalogOutput) Core.getOutputManager().getOutput(WSOutputs.FRONT_LEFT.getName()))
				.setValue(leftMotorSpeed * left_drive_bias);
		((AnalogOutput) Core.getOutputManager().getOutput(WSOutputs.REAR_LEFT.getName()))
				.setValue(leftMotorSpeed * left_drive_bias);
		((AnalogOutput) Core.getOutputManager().getOutput(WSOutputs.FRONT_RIGHT.getName()))
				.setValue(rightMotorSpeed * right_drive_bias);
		((AnalogOutput) Core.getOutputManager().getOutput(WSOutputs.REAR_RIGHT.getName()))
				.setValue(rightMotorSpeed * right_drive_bias);
		// ((AnalogOutput)
